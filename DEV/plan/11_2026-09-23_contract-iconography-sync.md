...
9. The source and licence of every copied glyph is on record (`ICON-EXTERNAL` rule 5), in a
   ...
   [`glyphs-snapshot-2026-09-25/README.md`](11_2026-09-23_contract-iconography-sync/glyphs-snapshot-2026-09-25/README.md).
...
- **⛔ Local only - changes the contract catalog.** **B9 cross-contract conflict:** `PAGE-STYLE` §9 recommends the kit glyphs `◐ ⤓ → ▸`; `ICON-SET` gives
  ...
  `product-web-pages/`). Linked from [`12_2026-09-23_contract-product-web-pages-sync`](12_2026-09-23_contract-product-web-pages-sync.md).
...
3. Rendering in the self-contained offline book: inline SVG per page, one CSS `mask` data-URI per page in
   ...
   [`glyphs-snapshot-2026-09-25/`](11_2026-09-23_contract-iconography-sync/glyphs-snapshot-2026-09-25/)

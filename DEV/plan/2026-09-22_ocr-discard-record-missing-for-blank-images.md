...
This also corrects a claim in this repo's own ledger: `DEV/plan/RELEASE_QUEUE.md` §1.3 states that the
...
- [ ] `DEV/plan/RELEASE_QUEUE.md` §1.3 is corrected in the entry that lands this, rather than rewritten in
      place.

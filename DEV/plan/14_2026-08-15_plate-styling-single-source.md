...
**Priority:** 44
**Date:** 2026-08-15
**Tactical plan:** [`14_2026-08-15_plate-styling-single-source/`](14_2026-08-15_plate-styling-single-source/INDEX.md)
...
> [`PHASE_05__parity-record.md`](14_2026-08-15_plate-styling-single-source/PHASE_05__parity-record.md)
> ("Contract snapshot (2026-09-25)"); Step 05.3 is the only ⛔ step.
...
| Website / docs | `[~]` | `docs/PARITY.md` gains the shared-appearance row, the named-divergence list and the guarded / prose-only mark on every invariant; the catalog's `OCR-PIPELINE.md` points at the single source instead of at two files. `docs/PARITY.md` done; the catalog edit is Step 05.3, **⛔ Local only - changes the contract catalog** |
...
- [`16_2026-08-13_ocr-sweep-plate-composition.md`](16_2026-08-13_ocr-sweep-plate-composition.md) - set the
...
### Manual / on-target
- [ ] **⛔ Local only - changes the contract catalog.** Step 05.3: repoint the catalog's
      `ocr-pipeline.md` plate rows and §3.1 at `internal/appearance`. The catalog is not reachable from a
      cloud session; the target text is quoted in PHASE_05's contract snapshot.

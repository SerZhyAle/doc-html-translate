# Strategic spec: 05_2026-09-24_hotfix-output-dir-ownership - Never delete or reuse a folder the converter does not own

**Ticket:** 05_2026-09-24_hotfix-output-dir-ownership
...
**Tactical plan:** `DEV/plan/05_2026-09-24_hotfix-output-dir-ownership/` (created by /spec-tech)
**Findings:** P1 P2 P6 P7 P16 P17 G9 G11 (see the [findings register](../../research/audit_2026-09-24/README.md))
...
## 12. Next step
`/spec-tech 05_2026-09-24_hotfix-output-dir-ownership` - creates the phased tactical plan.

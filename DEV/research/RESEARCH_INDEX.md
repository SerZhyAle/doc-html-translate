...
| 2026-08-12 | [`ocr_display_lettering_2026-08-12.md`](ocr_display_lettering_2026-08-12.md) | A poster comes back with one stray word on it. Which part of the shipped path loses the other ten, and does anything already in the code recover them? | Ticket [`2026-08-12_ocr-misses-display-lettering-on-saturated-art`](../plan/2026-08-12_ocr-misses-display-lettering-on-saturated-art.md). Settles that the ladder is reached and still fails, that the loss is at the line-mean gate, and that a sparse-text rung recovers six of nine lines; **corrects the ticket's own first cause**. |
